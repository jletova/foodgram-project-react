...
--
-- Name: api_favouriterecipe; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.api_favouriterecipe (
    id integer NOT NULL,
...
ALTER TABLE public.api_favouriterecipe OWNER TO postgres;

--
-- Name: api_favouriterecipe_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.api_favouriterecipe_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.api_favouriterecipe_id_seq OWNER TO postgres;

--
-- Name: api_favouriterecipe_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.api_favouriterecipe_id_seq OWNED BY public.api_favouriterecipe.id;
...
CREATE TABLE public.api_follow (
    ...
    user_id integer NOT NULL,
    CONSTRAINT self_following CHECK ((NOT (user_id = following_id)))
);
...
--
-- Name: api_ingredientsamount; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.api_ingredientsamount (
    id integer NOT NULL,
    amount smallint NOT NULL,
    ingredient_id integer NOT NULL,
    recipe_id integer NOT NULL,
    CONSTRAINT api_ingredientsamount_amount_check CHECK ((amount >= 0))
);


ALTER TABLE public.api_ingredientsamount OWNER TO postgres;

--
-- Name: api_ingredientsamount_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.api_ingredientsamount_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.api_ingredientsamount_id_seq OWNER TO postgres;

--
-- Name: api_ingredientsamount_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.api_ingredientsamount_id_seq OWNED BY public.api_ingredientsamount.id;


--
-- Name: api_isinshoppingcart; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.api_isinshoppingcart (
    id integer NOT NULL,
    recipe_id integer NOT NULL,
    user_id integer NOT NULL
);
...
ALTER TABLE public.api_isinshoppingcart OWNER TO postgres;

--
-- Name: api_isinshoppingcart_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.api_isinshoppingcart_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.api_isinshoppingcart_id_seq OWNER TO postgres;

--
-- Name: api_isinshoppingcart_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.api_isinshoppingcart_id_seq OWNED BY public.api_isinshoppingcart.id;
...
--
-- Name: api_favouriterecipe id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.api_favouriterecipe ALTER COLUMN id SET DEFAULT nextval('public.api_favouriterecipe_id_seq'::regclass);
...
--
-- Name: api_ingredientsamount id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.api_ingredientsamount ALTER COLUMN id SET DEFAULT nextval('public.api_ingredientsamount_id_seq'::regclass);


--
-- Name: api_isinshoppingcart id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.api_isinshoppingcart ALTER COLUMN id SET DEFAULT nextval('public.api_isinshoppingcart_id_seq'::regclass);
...
--
-- Data for Name: api_favouriterecipe; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.api_favouriterecipe (id, recipe_id, user_id) FROM stdin;
1	4	1
2	2	7
\.
...
COPY public.api_follow (id, following_id, user_id) FROM stdin;
\.
...
--
-- Data for Name: api_ingredientsamount; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.api_ingredientsamount (id, amount, ingredient_id, recipe_id) FROM stdin;
1	350	2187	1
2	2000	5	2
4	11	1051	4
\.
...
--
-- Data for Name: api_isinshoppingcart; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.api_isinshoppingcart (id, recipe_id, user_id) FROM stdin;
2	1	6
4	1	7
5	2	7
\.
...
COPY public.api_recipe (id, name, text, image, cooking_time, author_id) FROM stdin;
1	Карпаччо из свеклы	Смешайте в небольшой миске чайную ложку меда, листочки тимьяна и молотый перец. Затем нарежьте овощ на очень тонкие кружочки и слегка перемешайте с медовым соусом. Переложите свеклу в вакуумный пакет и запекайте в духовке при температуре 70 градусов не более 60 минут. Тонко нарежьте при подаче.	recipes/43483840-6684-4996-995d-57543f3f0ae6.jpg	20	1
2	Абрикосовый джем	Для джема нужно выбирать только зрелые или слегка недозрелые плоды.\nАбрикосы промыть в холодной воде, удалить косточки.\nПодготовленные плоды высыпать в посуду , налить воду и проварить 10 минут, затем засыпать сахар и варить до готовности 50 минут.	recipes/213b0514-3d89-49c2-8a62-f7149d0f2d86.jpg	50	1
4	Морепродукты отварные	Положите морепродукты в кипящую воду, пододжите 3 минуты, готово. Сервируйте с любимыми овощами.	recipes/f973ec7e-53f3-4c33-b3eb-2c594456d630.jpg	4	1
\.
...
3	Ужин	#599472	dinner
1	Завтрак	#ff992f	breakfast
2	Обед	#068cf7	lunch
\.
...
COPY public.api_user (id, last_login, is_superuser, is_staff, is_active, date_joined, email, username, first_name, last_name, password) FROM stdin;
2	\N	f	f	t	2022-05-29 12:55:19.791398+00	julialikh@gmail.com	jletova	Yuliya	Likholetova	pbkdf2_sha256$150000$pyxZQfctOd2g$AIrfR5HECrECCKswwAkNIIQd9PiQUBAWbJWlPv+mMYg=
5	2022-05-29 19:26:47+00	t	t	t	2022-05-29 13:39:49+00	mail@mickey.com	Mickey	Михаил	Петров	pbkdf2_sha256$150000$gwxhpFlQpAbY$ZT2CJidZyRa1Zh0RGL/y/x96BXy3CO//hioFjyQ2aLw=
4	2022-05-29 13:37:34+00	f	f	t	2022-05-29 13:17:42+00	mark@mark.com	mark	Mark	Прокоп	pbkdf2_sha256$150000$NKwEOtVic0PG$SVScxI2DilNSZvEnlXqzRK9H0O4j6BOMW2NRYIB0EZw=
3	\N	f	f	t	2022-05-29 12:56:57+00	mail@mail.ru	test_user	Test	User	pbkdf2_sha256$150000$PvwY5aV0eUDO$8vYJxlWKgNBJJQ5cfB14hD7TolsDfd50b7Ph5hpG730=
7	2022-05-29 19:43:46.196079+00	f	f	t	2022-05-29 19:43:37.886085+00	mail@doip.cz	suxx	Dodo	Suxx	pbkdf2_sha256$150000$1CDRfyjuVoSV$sjTQZUedUeE0VR9qUlq9HuYmRERYQbFgco3lbcBEhFs=
6	2022-05-29 20:38:50.829571+00	f	f	t	2022-05-29 15:50:44+00	df@rf.com	Oleg.Popov	Олег	Попов	pbkdf2_sha256$150000$mPAM2fCA8WIw$qKpI6GXPuhb/9a8kDyrM4dIq6F6CuAcKCgkMex8xUgU=
1	2022-05-30 09:45:39.059967+00	t	t	t	2022-05-29 12:54:56.838696+00	mail@mail.com	Test	User	Test	pbkdf2_sha256$150000$0VgL46GnYsVP$O+8N+qEH98dzw2bTLCxHO7aZilTU8x7v5mCGjx5vh6I=
\.
...
25	Can add Любимый рецепт	7	add_favouriterecipe
26	Can change Любимый рецепт	7	change_favouriterecipe
27	Can delete Любимый рецепт	7	delete_favouriterecipe
28	Can view Любимый рецепт	7	view_favouriterecipe
29	Can add Подписка	8	add_follow
30	Can change Подписка	8	change_follow
31	Can delete Подписка	8	delete_follow
32	Can view Подписка	8	view_follow
33	Can add Ингридиент	9	add_ingredient
34	Can change Ингридиент	9	change_ingredient
35	Can delete Ингридиент	9	delete_ingredient
36	Can view Ингридиент	9	view_ingredient
37	Can add Количество	10	add_ingredientsamount
38	Can change Количество	10	change_ingredientsamount
39	Can delete Количество	10	delete_ingredientsamount
40	Can view Количество	10	view_ingredientsamount
41	Can add Тег	11	add_tag
42	Can change Тег	11	change_tag
43	Can delete Тег	11	delete_tag
44	Can view Тег	11	view_tag
45	Can add Рецепт	12	add_recipe
46	Can change Рецепт	12	change_recipe
47	Can delete Рецепт	12	delete_recipe
48	Can view Рецепт	12	view_recipe
49	Can add Корзина покупок	13	add_isinshoppingcart
50	Can change Корзина покупок	13	change_isinshoppingcart
51	Can delete Корзина покупок	13	delete_isinshoppingcart
52	Can view Корзина покупок	13	view_isinshoppingcart
...
148bb1917e8a6aa96c16339fac1046f100951dfe	2022-05-29 13:37:26.759146+00	4
ff8e895cd18dd2df9065dc967b92989496eb6b97	2022-05-29 13:41:01.496922+00	1
99a2325baa4aa31ed59c9ab0dc3d40d4ffffcbc5	2022-05-29 20:38:50.825868+00	6
\.
...
1	2022-05-29 14:08:19.52553+00	1	Завтрак	1	[{"added": {}}]	11	5
2	2022-05-29 14:08:59.35941+00	2	Обед	1	[{"added": {}}]	11	5
3	2022-05-29 14:09:34.400011+00	3	Ужин	1	[{"added": {}}]	11	5
4	2022-05-29 14:10:07.561079+00	1	Завтрак	2	[{"changed": {"fields": ["color"]}}]	11	5
5	2022-05-29 14:10:41.982266+00	2	Обед	2	[{"changed": {"fields": ["color"]}}]	11	5
6	2022-05-29 18:24:23.331891+00	4	Морепродукты отварные	2	[{"changed": {"name": "\\u041a\\u043e\\u043b\\u0438\\u0447\\u0435\\u0441\\u0442\\u0432\\u043e", "object": "\\u043c\\u043e\\u0440\\u0435\\u043f\\u0440\\u043e\\u0434\\u0443\\u043a\\u0442\\u044b = 11", "fields": ["amount"]}}]	12	5
7	2022-05-29 19:27:23.14981+00	6	Oleg.Popov	2	[{"changed": {"fields": ["username", "first_name", "last_name"]}}]	6	5
8	2022-05-29 19:27:59.64276+00	5	Mickey	2	[{"changed": {"fields": ["email", "username", "first_name"]}}]	6	5
9	2022-05-29 19:28:12.567193+00	4	mark	2	[{"changed": {"fields": ["last_name"]}}]	6	5
10	2022-05-29 19:29:19.141827+00	3	test_user	2	[{"changed": {"fields": ["username", "first_name", "last_name"]}}]	6	5
\.
...
5	sessions	session
6	api	user
7	api	favouriterecipe
8	api	follow
9	api	ingredient
10	api	ingredientsamount
11	api	tag
12	api	recipe
13	api	isinshoppingcart
14	authtoken	token
...
1	contenttypes	0001_initial	2022-05-29 12:54:12.809683+00
2	contenttypes	0002_remove_content_type_name	2022-05-29 12:54:12.835115+00
3	auth	0001_initial	2022-05-29 12:54:12.878365+00
4	auth	0002_alter_permission_name_max_length	2022-05-29 12:54:12.913067+00
5	auth	0003_alter_user_email_max_length	2022-05-29 12:54:12.928302+00
6	auth	0004_alter_user_username_opts	2022-05-29 12:54:12.939919+00
7	auth	0005_alter_user_last_login_null	2022-05-29 12:54:12.952465+00
8	auth	0006_require_contenttypes_0002	2022-05-29 12:54:12.956788+00
9	auth	0007_alter_validators_add_error_messages	2022-05-29 12:54:12.967769+00
10	auth	0008_alter_user_username_max_length	2022-05-29 12:54:12.981943+00
11	auth	0009_alter_user_last_name_max_length	2022-05-29 12:54:12.994377+00
12	auth	0010_alter_group_name_max_length	2022-05-29 12:54:13.005609+00
13	auth	0011_update_proxy_permissions	2022-05-29 12:54:13.018515+00
14	api	0001_initial	2022-05-29 12:54:13.06105+00
15	admin	0001_initial	2022-05-29 12:54:13.137355+00
16	admin	0002_logentry_remove_auto_add	2022-05-29 12:54:13.175602+00
17	admin	0003_logentry_add_action_flag_choices	2022-05-29 12:54:13.192042+00
18	api	0002_auto_20220529_0754	2022-05-29 12:54:13.768174+00
19	authtoken	0001_initial	2022-05-29 12:54:13.907253+00
20	authtoken	0002_auto_20160226_1747	2022-05-29 12:54:14.052926+00
21	authtoken	0003_tokenproxy	2022-05-29 12:54:14.060162+00
22	sessions	0001_initial	2022-05-29 12:54:14.075828+00
\.
...
ew41vojeju9ros8i4zie8weu26svdn99	MDcwNmY4NjM2NGY5NDdiNGM3ZGJlODBiNzNlMzYxNTc5NDA4ODczMDp7Il9hdXRoX3VzZXJfaWQiOiIxIiwiX2F1dGhfdXNlcl9iYWNrZW5kIjoiZGphbmdvLmNvbnRyaWIuYXV0aC5iYWNrZW5kcy5Nb2RlbEJhY2tlbmQiLCJfYXV0aF91c2VyX2hhc2giOiJkODg3NGY4MWQxZDQ5OTRmMTA4ZDNkMmFiOGRkODNkMWQyZWI3YjczIn0=	2022-06-13 09:45:39.064414+00
\.


--
-- Name: api_favouriterecipe_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.api_favouriterecipe_id_seq', 2, true);
...
SELECT pg_catalog.setval('public.api_ingredient_id_seq', 2188, true);


--
-- Name: api_ingredientsamount_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.api_ingredientsamount_id_seq', 4, true);


--
-- Name: api_isinshoppingcart_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.api_isinshoppingcart_id_seq', 5, true);
...
SELECT pg_catalog.setval('public.api_recipe_id_seq', 4, true);
...
SELECT pg_catalog.setval('public.api_recipe_tags_id_seq', 7, true);
...
SELECT pg_catalog.setval('public.api_user_id_seq', 7, true);
...
--
-- Name: api_favouriterecipe api_favouriterecipe_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.api_favouriterecipe
    ADD CONSTRAINT api_favouriterecipe_pkey PRIMARY KEY (id);
...
--
-- Name: api_ingredientsamount api_ingredientsamount_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.api_ingredientsamount
    ADD CONSTRAINT api_ingredientsamount_pkey PRIMARY KEY (id);


--
-- Name: api_isinshoppingcart api_isinshoppingcart_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.api_isinshoppingcart
    ADD CONSTRAINT api_isinshoppingcart_pkey PRIMARY KEY (id);
...
--
-- Name: api_tag api_tag_name_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: api_follow unique_follow; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.api_follow
    ADD CONSTRAINT unique_follow UNIQUE (user_id, following_id);


--
-- Name: api_favouriterecipe unique_follow_recipe; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.api_favouriterecipe
    ADD CONSTRAINT unique_follow_recipe UNIQUE (user_id, recipe_id);


--
-- Name: api_ingredient unique_ingredient_and_measurement; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.api_ingredient
    ADD CONSTRAINT unique_ingredient_and_measurement UNIQUE (name, measurement_unit);


--
-- Name: api_ingredientsamount unique_ingredient_in_recipe; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: api_recipe unique_recipe; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.api_recipe
    ADD CONSTRAINT unique_recipe UNIQUE (name, author_id, text);


--
-- Name: api_isinshoppingcart unique_shopping_cart; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: api_favouriterecipe_recipe_id_b522f84a; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX api_favouriterecipe_recipe_id_b522f84a ON public.api_favouriterecipe USING btree (recipe_id);


--
-- Name: api_favouriterecipe_user_id_eee6855f; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX api_favouriterecipe_user_id_eee6855f ON public.api_favouriterecipe USING btree (user_id);
...
--
-- Name: api_follow_user_id_c804fe25; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX api_follow_user_id_c804fe25 ON public.api_follow USING btree (user_id);


--
-- Name: api_ingredientsamount_ingredient_id_c628b313; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX api_ingredientsamount_ingredient_id_c628b313 ON public.api_ingredientsamount USING btree (ingredient_id);


--
-- Name: api_ingredientsamount_recipe_id_99d32bd8; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX api_ingredientsamount_recipe_id_99d32bd8 ON public.api_ingredientsamount USING btree (recipe_id);


--
-- Name: api_isinshoppingcart_recipe_id_41de75be; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX api_isinshoppingcart_recipe_id_41de75be ON public.api_isinshoppingcart USING btree (recipe_id);


--
-- Name: api_isinshoppingcart_user_id_b89e5c79; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX api_isinshoppingcart_user_id_b89e5c79 ON public.api_isinshoppingcart USING btree (user_id);
...
--
-- Name: api_tag_name_e0f7a95d_like; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: api_favouriterecipe api_favouriterecipe_recipe_id_b522f84a_fk_api_recipe_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.api_favouriterecipe
    ADD CONSTRAINT api_favouriterecipe_recipe_id_b522f84a_fk_api_recipe_id FOREIGN KEY (recipe_id) REFERENCES public.api_recipe(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: api_favouriterecipe api_favouriterecipe_user_id_eee6855f_fk_api_user_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.api_favouriterecipe
    ADD CONSTRAINT api_favouriterecipe_user_id_eee6855f_fk_api_user_id FOREIGN KEY (user_id) REFERENCES public.api_user(id) DEFERRABLE INITIALLY DEFERRED;
...
--
-- Name: api_follow api_follow_user_id_c804fe25_fk_api_user_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.api_follow
    ADD CONSTRAINT api_follow_user_id_c804fe25_fk_api_user_id FOREIGN KEY (user_id) REFERENCES public.api_user(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: api_ingredientsamount api_ingredientsamoun_ingredient_id_c628b313_fk_api_ingre; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.api_ingredientsamount
    ADD CONSTRAINT api_ingredientsamoun_ingredient_id_c628b313_fk_api_ingre FOREIGN KEY (ingredient_id) REFERENCES public.api_ingredient(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: api_ingredientsamount api_ingredientsamount_recipe_id_99d32bd8_fk_api_recipe_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.api_ingredientsamount
    ADD CONSTRAINT api_ingredientsamount_recipe_id_99d32bd8_fk_api_recipe_id FOREIGN KEY (recipe_id) REFERENCES public.api_recipe(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: api_isinshoppingcart api_isinshoppingcart_recipe_id_41de75be_fk_api_recipe_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.api_isinshoppingcart
    ADD CONSTRAINT api_isinshoppingcart_recipe_id_41de75be_fk_api_recipe_id FOREIGN KEY (recipe_id) REFERENCES public.api_recipe(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: api_isinshoppingcart api_isinshoppingcart_user_id_b89e5c79_fk_api_user_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.api_isinshoppingcart
    ADD CONSTRAINT api_isinshoppingcart_user_id_b89e5c79_fk_api_user_id FOREIGN KEY (user_id) REFERENCES public.api_user(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: api_recipe api_recipe_author_id_423d4c07_fk_api_user_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.api_recipe
    ADD CONSTRAINT api_recipe_author_id_423d4c07_fk_api_user_id FOREIGN KEY (author_id) REFERENCES public.api_user(id) DEFERRABLE INITIALLY DEFERRED;
